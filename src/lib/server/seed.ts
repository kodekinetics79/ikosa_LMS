...
export function seedDatabase(): Database {
  return {
    ...
    courses: [
      { id: "crs_loto", tenantId: "ten_northstar", orgUnitId: "org_ns_ops", code: "LOTO-401", title: "Lockout/Tagout authorized person", description: "Energy isolation to the authorized-person standard, including the NSU-SOP-104 sequence and field verification.", skillId: "skill_loto", targetLevel: 4, evidenceRule: "assessed", passingScore: 0.8, validityMonths: 12, version: 3, status: "published", createdAt, visibility: "organization", summary: "", instructorUserId: null, listPriceCents: null, currency: null },
      { id: "crs_diag", tenantId: "ten_northstar", orgUnitId: "org_ns_ops", code: "DIAG-210", title: "Distribution fault diagnosis", description: "Instrument-led fault diagnosis on distribution assets, including the revised meter diagnostic branch.", skillId: "skill_diag", targetLevel: 3, evidenceRule: "assessed", passingScore: 0.75, validityMonths: 24, version: 2, status: "published", createdAt, visibility: "organization", summary: "", instructorUserId: null, listPriceCents: null, currency: null },
      { id: "crs_storm", tenantId: "ten_northstar", orgUnitId: "org_ns_ops", code: "BRIEF-STORM", title: "Storm season safety briefing", description: "Annual awareness briefing. Attendance is recorded; it does not evidence competence.", skillId: "skill_loto", targetLevel: 1, evidenceRule: "attendance_only", passingScore: 0, validityMonths: null, version: 1, status: "published", createdAt, visibility: "organization", summary: "", instructorUserId: null, listPriceCents: null, currency: null },
      { id: "crs_gulf", tenantId: "ten_gulf", orgUnitId: "org_ge", code: "GES-PS-100", title: "Process safety fundamentals", description: "Site process safety controls.", skillId: "skill_gulf_safe", targetLevel: 4, evidenceRule: "assessed", passingScore: 0.8, validityMonths: 12, version: 1, status: "published", createdAt, visibility: "organization", summary: "", instructorUserId: null, listPriceCents: null, currency: null },
    ],
    courseModules: [
      { id: "mod_loto_1", tenantId: "ten_northstar", courseId: "crs_loto", position: 1, title: "Energy isolation principles", kind: "lesson", durationMinutes: 25, required: true, assessmentId: null },
      { id: "mod_loto_2", tenantId: "ten_northstar", courseId: "crs_loto", position: 2, title: "NSU-SOP-104 v7 procedure walkthrough", kind: "document", durationMinutes: 20, required: true, assessmentId: null },
      { id: "mod_loto_3", tenantId: "ten_northstar", courseId: "crs_loto", position: 3, title: "Isolation sequence simulation", kind: "scorm", durationMinutes: 35, required: true, assessmentId: null },
      { id: "mod_loto_4", tenantId: "ten_northstar", courseId: "crs_loto", position: 4, title: "Authorized person assessment", kind: "assessment", durationMinutes: 30, required: true, assessmentId: null },
      { id: "mod_diag_1", tenantId: "ten_northstar", courseId: "crs_diag", position: 1, title: "Meter diagnostic decision branch", kind: "lesson", durationMinutes: 30, required: true, assessmentId: null },
      { id: "mod_diag_2", tenantId: "ten_northstar", courseId: "crs_diag", position: 2, title: "Fault diagnosis assessment", kind: "assessment", durationMinutes: 25, required: true, assessmentId: null },
      { id: "mod_storm_1", tenantId: "ten_northstar", courseId: "crs_storm", position: 1, title: "Storm season briefing", kind: "video", durationMinutes: 15, required: true, assessmentId: null },
      { id: "mod_gulf_1", tenantId: "ten_gulf", courseId: "crs_gulf", position: 1, title: "Process safety controls", kind: "lesson", durationMinutes: 40, required: true, assessmentId: null },
      { id: "mod_gulf_2", tenantId: "ten_gulf", courseId: "crs_gulf", position: 2, title: "Process safety assessment", kind: "assessment", durationMinutes: 30, required: true, assessmentId: null },
    ],
    enrollments: [
